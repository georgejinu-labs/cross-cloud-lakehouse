-- Manual Oracle setup — run as healthcare user on XEPDB1
-- docker exec -it oracle-xe bash
-- sqlplus 'healthcare/<YOUR_ORACLE_PASSWORD>@//localhost/XEPDB1'
...
SELECT 'claims'  AS tbl, COUNT(*) AS rows FROM claims;
